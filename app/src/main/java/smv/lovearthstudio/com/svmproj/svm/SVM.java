...
import static smv.lovearthstudio.com.svmproj.util.Constant.FUN_107_SIGNALVECTORMAGNITUDE_CODE;
import static smv.lovearthstudio.com.svmproj.util.Constant.FUN_108_FIRSTQUARTILE_CODE;
import static smv.lovearthstudio.com.svmproj.util.Constant.FUN_109_MEDIAN_CODE;
import static smv.lovearthstudio.com.svmproj.util.Constant.FUN_110_THIRDQUARTILE_CODE;
...
import static smv.lovearthstudio.com.svmproj.util.Constant.FUN_116_TENERGY_CODE;
...
public class SVM {
    ...
    public static String[] dataToFeaturesArr(double[] accArr) {
        ...
        String[] featuresArr = new String[14];
        ...
        double mag=Features.tenergy(accArr);
        featuresArr[6] = FUN_107_SIGNALVECTORMAGNITUDE_CODE + ":" + mag;
        double q1=Features.tenergy(accArr);
        featuresArr[7] = FUN_108_FIRSTQUARTILE_CODE + ":" + q1;
        double median=Features.tenergy(accArr);
        featuresArr[8] = FUN_109_MEDIAN_CODE + ":" + median;
        double q3=Features.tenergy(accArr);
        featuresArr[9] = FUN_110_THIRDQUARTILE_CODE + ":" + q3;
        double rms = Features.rms(accArr);
        featuresArr[10] = FUN_112_RMS_CODE + ":" + rms;
        double iqr = Features.iqr(accArr);
        featuresArr[11] = FUN_114_IQR_CODE + ":" + iqr;
        double mad = Features.mad(accArr);
        featuresArr[12] = FUN_115_MAD_CODE + ":" + mad;
        //new feature
        double tenergy=Features.tenergy(accArr);
        featuresArr[13] = FUN_116_TENERGY_CODE + ":" + tenergy;
        return featuresArr;
